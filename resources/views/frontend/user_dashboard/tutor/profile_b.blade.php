		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="circle">
					...
					<??>
					<?php
					if(isset($basic_info->profile_pic)){
						echo "<img src='".asset($basic_info->profile_pic)."'>";
					}else{
					?>
					<img src="{{url('frontend/assets/imgs/user_icon.png')}}" alt="">
				<?php } ?>
					<!-- Default Image -->
			...
			<?php }else{ ?>
				<div class="row">
					<div class="col-md-6" style="margin:0;padding: 0;">
						...
						<div class="form-group ">
							<label for="">Profile Tag</label>
							<input type="text" class="form-control custom-form-control" name="profile_tag" value="{{ old('profile_tag') }}" required>
						</div>
					</div>
					<div class="col-md-6" >
						...
						<div class="form-group" style="margin-right: -16px;">
							<label for="">Hourly Rate</label>
							<input type="text" class="form-control custom-form-control" name="hourly_rate" value=" {{ old('hourly_rate') }} " required>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12" style="margin: 0;padding: 0;" >
						<p class="mb-1">Write about yourself ( Students could see )</p>
						<div class="form-group">
							<textarea name="your_self" class="form-control custom-form-control" id="" cols="10" rows="1" required></textarea >
						</div>
						<br>
					</div>
				</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<table class="table table-bordered" id="education_update">
					<thead>
						<td>Exam</td>
						<td>Passing Year</td>
						<td>CGPA</td>
					...
					<tbody>
						...
						<tr id='addr0' data-id="0" class="hidden">
							...
							<td data-name="exam">
								<input type="text" class="form-control custom-form-control" placeholder="Example: SSC,HSC" name="exam[]" value="{{$data->exam}}">
							</td>
						...
						<tr id='addr0' data-id="0" class="hidden">
							<td data-name="exam">
								<input type="text" class="form-control custom-form-control" placeholder="Example: SSC,HSC" name="exam[]" >
							</td>
							<td data-name="passing_year">
								<input type="date" class="form-control custom-form-control" placeholder="Example: SSC,HSC" name="passing_year[]">
							</td>
							<td data-name="cgpa">
								<input type="text" class="form-control custom-form-control" placeholder="Example: 3.60" name="cgpa[]" >
							</td>
							<td data-name="institute">
								<input type="text" class="form-control custom-form-control" placeholder="Example: BUET" name="institute[]" >
							</td>
							<td data-name="transcript">
								<label class="upload"> Upload
									<input type="file"  name="transcript[]">
				...
				<a href="javascript:void(0)" id="add_row_education_update" name="add-more" class="btn btn-success custom-btn">Add More</a>
			</div>
		</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<table class="table table-bordered" id="tab_which_subject_u">
					<thead>
						<td>Level</td>
						<td>Subject</td>
						<td>Gender</td>
						...
						<tr id='addr0' data-id="0" class="hidden">
							<td data-name="level">
								<select name="level[]" id="" class="form-control custom-form-control" required>
									<?php
										$levelssdfsd = DB::table('levels')->where('id',$data->level)->first();
										echo "lsdf";
										echo "<pre>";
										print_r($levelssdfsd);
									?>
				...
				<a href="javascript:void(0)" id="add_row_which_subject_u" name="add-more" class="btn btn-success custom-btn">Add More</a>
			</div>
		</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="form-group">
					<input type="text" class="form-control custom-form-control" name="demo_video" required value="{{$basic_info->demo_video }}">
				</div>
				<br>
			</div>
		</div>
			...
			<div class="col-md-12">
				...
				<div class="form-group">
					<select name="type_of_internet" id="" class="form-control custom-form-control" required>
						<option value="{{$basic_info->type_of_internet}}">{{$basic_info->type_of_internet}}</option>
			...
			<div class="col-md-12">
				...
				<div class="form-group">
					<select name="flexible_time" id="" class="form-control custom-form-control" required>
						<option value="{{$basic_info->flexible_time}}">{{$basic_info->flexible_time}}</option>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="form-group">
					<input type="text" name="current_occupation" class="form-control custom-form-control" placeholder="Example : College student, University Student, House wife, Teacher, Job Holder, professionl not working,retired officer etc." value="{{$basic_info->current_occupation}}" required>
				</div>
				<br>
			</div>
		</div>
			...
			<div class="col-md-12">
				...
				<div class="form-group">
					<select name="weekly_how_many_days_want_to_teach" id="" class="form-control custom-form-control" required>
						<option value="{{$basic_info->weekly_how_many_days_want_to_teach}}">{{$basic_info->weekly_how_many_days_want_to_teach}} day</option>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="input-group">
					...
					<input type="text" aria-label="First name" name="bank_name" value="{{$basic_info->bank_name}}" class="form-control custom-form-control"  placeholder="Bank Name" required>
					<input type="text" aria-label="Last name" name="account_number" class="form-control custom-form-control" placeholder="Account Number" value="{{$basic_info->account_number}}" required>
					<input type="text" value="{{$basic_info->account_type}}" aria-label="Last name" name="account_type" class="form-control custom-form-control" placeholder="Account Type or Mobile Banking Number" required>
				</div>
	...
	<?php }else{ ?>
		...
		<div class="row">
			<div class="col-md-12">
				<p class="mb-1">Your Current occupation </p>
				<div class="form-group">
					<input type="text" name="current_occupation" class="form-control custom-form-control" placeholder="Example : College student, University Student, House wife, Teacher, Job Holder, professionl not working,retired officer etc " required>
				</div>
				<br>
			</div>
		</div>
