				...
				<table class="table table-bordered" id="tab_logic">
					...
					<tbody>
						...
						<tr id='addr0' data-id="0" class="hidden">
							<td data-name="exam">
								<input type="text" class="form-control custom-form-control" placeholder="Example: SSC,HSC" name="exam[]" value="{{ old('exam')}}" required>
								@if($errors->has('exam[]'))
			                        <span class="invalid-feedback" role="alert">
							...
							<td data-name="passing_year">
								<input type="year" id="datepicker" class="form-control custom-form-control" placeholder="Passing Year" name="passing_year[]" value="{{ old('passing_year') }}" required>
							...
							<td data-name="institute">
								<input type="text" class="form-control custom-form-control" placeholder="Example: BUET" name="institute[]" value="{{ old('cgpa') }}" required>
				...
				<table class="table table-bordered" id="tab_which_subject">
					...
					<tbody>
						...
						<tr id='addr0' data-id="0" class="hidden">
							...
							<td data-name="price">
								<input type="number" class="form-control custom-form-control" name="price[]" value="{{old('price')}}">
								@if($errors->has('price'))
			                        <span class="invalid-feedback" role="alert">
				...
				<table class="table table-bordered" id="tab_geographic_info">
					...
					<tbody>
						...
						<tr id='addr0' data-id="0" class="hidden">
							...
							<td data-name="state">
								<input type="text" class="form-control custom-form-control" name="state[]" value="{{old('state')}}" required>
							</td>
							<td data-name="education_board">
								<input type="text" name="education_board[]" class="form-control custom-form-control" value="{{old('education_board')}}" required>
							</td>
							<td data-name="district">
								<input type="text" name="district[]" class="form-control custom-form-control" value="{{old('district')}}" required>
							</td>
