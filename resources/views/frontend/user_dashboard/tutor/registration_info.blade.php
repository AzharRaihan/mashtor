...
<div class="registration-info">
            	...
            	<div class="row">
            		<div class="col-md-6">
                        ...
                        <?php
                                    $studentInfo = DB::table('tutor_basic_infos')->where('user_id',Auth::user()->id)->first();
                                ...
                                <form method="post" action="{{url('tutor/profile/pic/update',Auth::user()->id)}}" enctype="multipart/form-data">
                                    ...
                                    <?php echo "<img id='blah' src='".asset($studentInfo->profile_pic)."' alt='' style='height: 150px;width: 100%:'' />"; ?>
                                    
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="profile_pic" id="imgInp" class="custom-file-input"  aria-describedby="inputGroupFileAddon04" required>
            	...
            	<div class="row">
            		<div class="col-md-12">
            			...
            			<div class="row">
            				<div class="col-md-6">
            					<p>First Name: <b>{{Auth::user()->f_name}}</b></p>
            				</div>
            				<div class="col-md-6">
            					<p>Last Name: <b>{{Auth::user()->l_name}}</b></p>
            				</div>
            			...
            			<div class="row">
            				...
            				<div class="col-md-6">
								<p>Date Of Birth : <b> {{Auth::user()->dob}}  </b> </p>
            				</div>
            			...
            			<div class="row">
            				<div class="col-md-6">
            					<p>Phone Number : <b> {{Auth::user()->number}} </b></p>
            				</div>
            				<div class="col-md-6">
            					<p>TNR Code : <b> {{Auth::user()->tnr}}  </b> </p>
            				</div>
            			</div>
            			<br>
            			<div class="row">
            				...
            				<div class="col-md-6">
            					<p>Upozila : <b>{{Auth::user()->upozila}}</b></p>
            				</div>
            			</div>
            			<br>
            			<div class="row">
            				<div class="col-md-6">
            					<p>Upozila : <b>{{Auth::user()->district}}</b></p>
            				</div>
            				<div class="col-md-6">
            					<p>Upozila : <b>{{Auth::user()->country}}</b></p>
            				</div>
            			</div>
            			<br>
            			<div class="row">
            				<div class="col-md-6">
            					<p>Native Language : <b>{{Auth::user()->n_lan}}</b></p>
            				</div>
            				<div class="col-md-6">
            					<p>Second Language : <b>{{Auth::user()->s_lan}}</b></p>
            				</div>
            			</div>
            		</div>
            	</div>
