				...
				<div class="col-md-6">
												...
												<form action="{{route('faculty.update',$faculty->id)}}" method="post">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" name="faculty" required value="{{$faculty->faculty}}">
													</div>
													<div class="form-group">
														<label for="">Level</label>
														<select name="level" id="" class="form-control" required>
															<?php
																$level_data = DB::table('levels')->where('id',$faculty->level)->first();
																if(isset($level_data)){
															?>
												...
												<a href="{{route('faculty.index')}}" class="btn btn-info">Back</a>
											</div>
										</div>
									</div>
								</div>
