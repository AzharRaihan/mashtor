        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card-box">
                    ...
                    <form action="{{url('admin/about/values/store')}}" method="post" enctype="multipart/form-data">
                        @csrf
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="{{url('admin/about/values/update',$data->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <section>
                            ...
                            <button type="submit" class="btn btn-outline-info">Save</button>
                                    ...
                                    <a href="{{url('admin/about/values/destroy',$data->id)}}" onClick="return deleteconfirm();">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
