        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card-box">
                    ...
                    <h3>Create Vission for about us page</h3>
                    <form action="{{url('admin/about/vission/store')}}" method="post" enctype="multipart/form-data">
                        @csrf
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{url('admin/about/vission/update',$data->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <section>
                            ...
                            <button type="submit" class="btn btn-outline-info">Update</button>
                                    ...
                                    <a href="{{url('admin/about/vission/destroy',$data->id)}}" onClick="return deleteconfirm();">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
